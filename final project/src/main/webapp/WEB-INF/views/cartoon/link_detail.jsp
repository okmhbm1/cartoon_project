    ...
    <hr style="border:1px solid black;"></hr>
     <c:forEach items="${list2}" var="tmp" varStatus="count">
           ...
           <c:forEach items="${list2}" var="tmp" varStatus="count">
            ...
            <div>
            <a href="detail.do?num=${tmp.num}">
            <img class="match_parent" src="${tmp.image_url}"/><span class="weekly_up_badge2">업데이트</span></a>
            </div>
            <div class="texttext"><a href="detail.do?num=${tmp.num}">${tmp.title}</a></div>
            <div style="display:none">${tmp.days }</div>
            </div>
           ...
           <c:forEach items="${list2}" var="tmp" varStatus="count">
            ...
            <div>
            <a href="detail.do?num=${tmp.num}">
            <img class="match_parent" src="${tmp.image_url}"/><span class="weekly_up_badge3">업데이트</span></a>
            </div>
            <div class="texttext"><a href="detail.do?num=${tmp.num}">${tmp.title}</a></div>
            <div style="display:none">${tmp.days }</div>
            </div>
           ...
           <c:forEach items="${list2}" var="tmp" varStatus="count">
            ...
            <div>
            <a href="detail.do?num=${tmp.num}">
            <img class="match_parent" src="${tmp.image_url}"/><span class="weekly_up_badge4">업데이트</span></a>
            </div>
            <div class="texttext"><a href="detail.do?num=${tmp.num}">${tmp.title}</a></div>
            <div style="display:none">${tmp.days }</div>
            </div>
           ...
           <c:forEach items="${list2}" var="tmp" varStatus="count">
            ...
            <div>
            <a href="detail.do?num=${tmp.num}">
            <img class="match_parent" src="${tmp.image_url}"/><span class="weekly_up_badge5">업데이트</span></a>
            </div>
            <div class="texttext"><a href="detail.do?num=${tmp.num}">${tmp.title}</a></div>
            <div style="display:none">${tmp.days }</div>
            </div>
           ...
           <c:forEach items="${list2}" var="tmp" varStatus="count">
            ...
            <div>
            <a href="detail.do?num=${tmp.num}">
            <img class="match_parent" src="${tmp.image_url}"/><span class="weekly_up_badge6">업데이트</span></a>
            </div>
            <div class="texttext"><a href="detail.do?num=${tmp.num}">${tmp.title}</a></div>
            <div style="display:none">${tmp.days }</div>
            </div>
           ...
           <c:forEach items="${list2}" var="tmp" varStatus="count">
            ...
            <div>
            <a href="detail.do?num=${tmp.num}">
            <img class="match_parent" src="${tmp.image_url}"/><span class="weekly_up_badge0">업데이트</span></a>
            </div>
            <div class="texttext"><a href="detail.do?num=${tmp.num}">${tmp.title}</a></div>
            <div style="display:none">${tmp.days }</div>
            </div>
